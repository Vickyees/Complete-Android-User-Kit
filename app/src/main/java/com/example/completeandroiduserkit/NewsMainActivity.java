...
public class NewsMainActivity extends AppCompatActivity {
    ...
    private String webUrl="https://timesofindia.indiatimes.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String s, final String s1, final String s2, final String s3, long l) {
                ...
                Dexter.withActivity(NewsMainActivity.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(NewsMainActivity.this, "Downloading File..", Toast.LENGTH_SHORT).show();
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.setType("*/*");
                NewsMainActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"),
            ...
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(NewsMainActivity.this.getPackageManager()) != null) {
                    File photoFile = null;
                    ...
                    try {
                        ...
                        Toast.makeText(NewsMainActivity.this, "error", Toast.LENGTH_SHORT).show();
                    }
                    if (photoFile != null) {
