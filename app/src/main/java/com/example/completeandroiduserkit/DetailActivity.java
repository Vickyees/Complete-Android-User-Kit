...
public class DetailActivity extends AppCompatActivity {
    ...
    private static final String ADMOB_AD_UNIT_ID = "ca-app-pub-7762392222724955/6512401178";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        at=(TextView)findViewById(R.id.addTitle);
        al=(TextView)findViewById(R.id.addLocation);
        ad=(TextView)findViewById(R.id.adddDesc);
        as=(TextView)findViewById(R.id.addSer);
        ac=(TextView)findViewById(R.id.addContact);
        ...
        if (bundle!=null){
            ...
            at.setText(bundle.getString("Title"));
            al.setText(bundle.getString("Location"));
            ad.setText(bundle.getString("Des"));
            as.setText(bundle.getString("Service"));
            ac.setText("Contact :"+bundle.getString("Contact"));
            key=bundle.getString("Key");
        }

        MobileAds.initialize(this,"ca-app-pub-7762392222724955~2438737873") ;
        MadView = findViewById(R.id.DadView);
            ...
            public void onClick(View view) {
                ...
                storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(DetailActivity.this, "Advertise Deleted", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DetailActivity.this,WhatsNew.class));
                        finish();
                    }
                });
            }
