...
public class WallMainActivity extends AppCompatActivity {
    ...
    private String webUrl="https://www.setaswall.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String s, final String s1, final String s2, final String s3, long l) {
                ...
                Dexter.withActivity(WallMainActivity.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(WallMainActivity.this, "Downloading File..", Toast.LENGTH_SHORT).show();
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.setType("*/*");
                WallMainActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"),
            ...
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(WallMainActivity.this.getPackageManager()) != null) {
                    File photoFile = null;
                    ...
                    try {
                        ...
                        Toast.makeText(WallMainActivity.this, "error", Toast.LENGTH_SHORT).show();
                    }
                    if (photoFile != null) {
            ...
            builder.setMessage("Are you Sure Want to Exit ? ")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            finish();
                            Intent intent=new Intent(WallMainActivity.this,MainActivity.class);
