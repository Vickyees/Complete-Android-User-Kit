...
public class Emergency extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference storageReference=storage.getReferenceFromUrl("gs://complete-android-user-kit.appspot.com/").child(card).child(uid);
        ...
        try {
            ...
            storageReference.getFile(file).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Emergency.this, "Image Not Available", Toast.LENGTH_SHORT).show();
                    i.setImageDrawable(getResources().getDrawable(R.drawable.not));
                }
            });
        } catch (IOException e) {
            e.printStackTrace();
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()) {
                    ...
                    Toast.makeText(Emergency.this, "add the data", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Emergency.this, "network error", Toast.LENGTH_SHORT).show();
            }
    ...
    public void pro(View view) {
        ...
        Intent intent=new Intent(Emergency.this,Pro_pic.class);
