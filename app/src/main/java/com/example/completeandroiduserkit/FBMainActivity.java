...
public class FBMainActivity extends AppCompatActivity {
    ...
    private String webUrl="https://www.facebook.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String s, final String s1, final String s2, final String s3, long l) {
                ...
                Dexter.withActivity(FBMainActivity.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(FBMainActivity.this, "Downloading File..", Toast.LENGTH_SHORT).show();
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.setType("*/*");
                FBMainActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"),
            ...
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(FBMainActivity.this.getPackageManager()) != null) {
                    File photoFile = null;
                    ...
                    try {
                        ...
                        Toast.makeText(FBMainActivity.this, "error", Toast.LENGTH_SHORT).show();
                    }
                    if (photoFile != null) {
    ...
    public void onBackPressed() {
        if (webView.canGoBack()) {
            webView.goBack();
                            ...
                            Intent intent=new Intent(FBMainActivity.this,MainActivity.class);
