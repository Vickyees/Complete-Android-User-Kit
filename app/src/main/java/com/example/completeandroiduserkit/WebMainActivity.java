...
public class WebMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webUrl = preferences.getString("url", "0");
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String s, final String s1, final String s2, final String s3, long l) {
                ...
                Dexter.withActivity(WebMainActivity.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(WebMainActivity.this, "Downloading File..", Toast.LENGTH_SHORT).show();
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.setType("*/*");
                WebMainActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"),
            ...
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(WebMainActivity.this.getPackageManager()) != null) {
                    File photoFile = null;
                    ...
                    try {
                        ...
                        Toast.makeText(WebMainActivity.this, "error", Toast.LENGTH_SHORT).show();
                    }
                    if (photoFile != null) {
